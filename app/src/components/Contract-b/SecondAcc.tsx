...
const SecondAccComponent = () => {
  ...
  const createSecondAcc = async () => {
    try {
      ...
      const ACCOUNT_SEED = 'Hello! Contract-B';
      ...
      console.log('SecondAcc: programId --->', programId.toString());
      console.log('SecondAcc: payer --->', payer.publicKey.toString());
      console.log(
        'SecondAcc: secondAccPubkey --->',
        secondAccPubkey.toString()
      );
